...
def train(args, train_dataset, model, tokenizer):
    ...
    if args.local_rank in [-1, 0]:
        tb_writer = SummaryWriter(args.run_name)
    ...
    scheduler = WarmupLinearSchedule(optimizer, warmup_steps=int(math.floor(t_total * args.warmup_ratio)), t_total=t_total)
    if args.fp16:
        try:
...
def main():
    ...
    parser.add_argument('--run_name', type=str, default='runs/exp-1', help="For logging tensorboard events.")
